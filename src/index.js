  ...
  const projectsWithTasks = [
    {
      ...
      tasks: [
        ...
        {
          title: "Team Meeting",
          description: "Discuss the project milestones",
          dueDate: "2025-04-28",
          priority: "Medium",
        },
        {
    ...
    },
    {
      ...
      tasks: [
        ...
        {
          title: "Plan Birthday",
          description: "Plan a surprise birthday party",
          dueDate: "2025-04-27",
          priority: "Medium",
        },
      ],
    },
    {
      ...
      tasks: [
        {
          title: "Morning Run",
          description: "Go for a 5km morning run",
          dueDate: "2025-04-27",
          priority: "Medium",
        },
        {
          title: "Yoga Session",
          description: "Attend the weekly yoga session",
          dueDate: "2025-04-28",
          priority: "Low",
        },
        {
          title: "Gym Workout",
          description: "Complete a 1-hour strength training",
          dueDate: "2025-04-29",
          priority: "High",
        },
      ],
